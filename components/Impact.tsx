...
const criteria = [
  { c: '#293681', t: 'استمرار العمل خلال آخر ٣ أشهر' },
  { c: '#33459a', t: 'تحقيق دخل فعلي شهري أو موسمي' },
  { c: '#4274D9', t: 'توسعة الخدمات أو دخول شراكة جديدة' },
  { c: '#5b96d6', t: 'تسجيل قانوني للنشاط التجاري' },
  { c: '#7bb8d8', t: 'خطة تطوير محدّثة للمشروع' },
  { c: '#95CCDD', t: 'استمرار التفاعل مع الزبائن والمجتمع الرقمي' },
];
